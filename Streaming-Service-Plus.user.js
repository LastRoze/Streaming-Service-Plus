...
// @source		https://github.com/LastRoze/Streaming-Service-Plus
// @icon		https://github.com/LastRoze/Streaming-Service-Plus/blob/master/DNA.jpg?raw=true
// @iconURL		https://github.com/LastRoze/Streaming-Service-Plus/blob/master/DNA.jpg?raw=true
// @defaulticon	https://github.com/LastRoze/Streaming-Service-Plus/blob/master/DNA.jpg?raw=true
// @icon64		https://github.com/LastRoze/Streaming-Service-Plus/blob/master/DNA.jpg?raw=true
// @icon64URL	https://github.com/LastRoze/Streaming-Service-Plus/blob/master/DNA.jpg?raw=true
...
class Controller {
  ...
  setupPopup() {
    ...
    this.popup.style.cssText = `
            ...
            background-image: url("https://raw.githubusercontent.com/LastRoze/Streaming-Service-Plus/master/Background.png");
...
async function initGMC() {
  ...
  supportBtn.addEventListener("click", () =>
    GM_openInTab("https://github.com/LastRoze/Streaming-Service-Plus/issues")
  );
    ...
    events: {
      ...
      open() {
        ...
        const sites = Array.from(
          methods.byID("Marathon_section_0").children
        ).slice(1, 6);
